...
example {n : ℤ} (hn : n ≥ 10) : n ^ 4 - 2 * n ^ 2 > 3 * n ^ 3 :=
  calc
    ...
    _ = (n * n * n * n - 2 * n * n - 3 * n * n * n) + 3 * n ^ 3 := by ring
    _ ≥ (10 * n * n * n - 2 * n * n - 3 * n * n * n) + 3 * n ^ 3 := by rel[hn]
    _ = (7 * n * n * n - 2 * n * n) + 3 * n ^ 3 := by ring
    _ ≥ (7 * 10 * n * n - 2 * n * n) + 3 * n ^ 3 := by rel[hn]
    _ = 68 * n * n + 3 * n ^ 3 := by ring
